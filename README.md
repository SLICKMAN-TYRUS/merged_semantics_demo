...
1. enabled: A boolean property that controls whether the merge happens. In the demo, I connected this to a switch so you can toggle merging on and off to hear the difference.
